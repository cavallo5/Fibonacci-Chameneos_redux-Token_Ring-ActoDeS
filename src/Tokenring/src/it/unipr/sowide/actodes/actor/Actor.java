...
public abstract class Actor implements Serializable
{
  ...
  **/
   ...
   *
  **/
  protected Map<MessagePattern, MessageHandler> dynDefs;
  ...
  **/
   ...
   *
  **/
  public abstract void add(final Message m);
  ...
  **/
   ...
   *
  **/
  public void future(final Reference a, final Object c,
  ...
  **/
  ...
  {
    Message r = message(m.getSender(),
        c, Type.TWOWAY, m.getIdentifier());
  ...
  **/
  public void future(final Message m,
      final Object c, final long t, final MessageHandler h)
  {
  ...
  **/
      ...
      final long t, final MessageHandler h)
  {
    if (t > 0)
    {
      ...
      {
        np = new MessagePattern(p, new MessagePatternField(
            MessageField.CONTENT, new Or<Object>(
  ...
  **/
  protected Entry<MessagePattern, MessageHandler> getDef(final Message m)
  {
    ...
    {
      return new SimpleEntry<MessagePattern, MessageHandler>(
          Behavior.ACCEPTALL, this.acceptAll);
    }
  ...
  **/
      ...
      final MessagePattern p, final MessageHandler h)
  {
    ...
    Logger.LOGGER.logMessageProcessed(
        this.behavior, p, m, System.nanoTime() - t);
  ...
  **/
  protected void processTimeout()
  {
    ...
    for (Entry<MessagePattern, Entry<Message, Long>> e
        : this.dTimeouts.entrySet())
    {
      if (isTimeoutExpired(e.getValue().getValue()))
      {
        if (e.getValue().getKey() != null)
        {
          Controller.CONTROLLER.getProvider().send(
              e.getValue().getKey(), Error.TIMEOUT);
        }
        else
        {
          Controller.CONTROLLER.getProvider().send(
              this.reference, Error.TIMEOUT);
        }
  ...
  **/
   ...
   *
  **/
  protected Message message(final Reference r,
      final Object c, final Type t, final long i)
  {
   ...
   *
  **/
  protected Message message(final List<Reference> l,
      final Object c, final Type t, final long i)
  {
