...
public final class Configuration extends PropertiesGroup
{
  ...
  **/
   ...
   *
  **/
  public void setLocale(final Properties p)
  {
    if (p.containsKey("locale"))
    {
      String[] l = p.getProperty("locale").split(",");

      if (l.length == 1)
      {
        Locale.setDefault(new Locale(l[0]));
      }
      else if (l.length == 2)
      {
      ...
      {
        Locale.setDefault(new Locale(l[0], l[1].concat(l[2])));
      }
    }
  }
