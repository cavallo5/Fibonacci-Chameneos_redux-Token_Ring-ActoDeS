...
public interface Storer extends Service
{
  ...
  **/
   ...
   *
  **/
  boolean save(final Configuration c, final String i);
   ...
   *
  **/
  Configuration retrieve(final String i);
  ...
  **/
   ...
   *
  **/
  boolean store(final Actor a, final String i);
